# Benhamida Oumaima , Master 1 Biochimie Appliquée , 12/12/2025
...
#calculer l'écart-type pour la colonne "Pourcentages GC" et la colonne "longueur"
std_GC = df["Pourcentages GC"].std()
...
nom_fichier="BenhamidaOumaima_M1_BA"
df.to_csv("BenhamidaOumaima_M1_B1.csv",index=False)

print(f"le tableau final a été sauvegardé dans le fichier:{nom_fichier}")
print("\n\n")
